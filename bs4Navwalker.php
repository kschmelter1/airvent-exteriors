...
class bs4Navwalker extends Walker_Nav_Menu
{
    ...
    public function get_classes( $item ) {
      return empty( $item->classes ) ? array() : (array) $item->classes;
    }
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        */
        ...
        if ($depth > 0 && in_array('menu-item-has-children', $classes)) {
            $item_output .= '<div class="dropdown-submenu">';
        }
        if (in_array('menu-item-has-children', $classes)) {
          $item_output .= '<a'. $attributes .'>';
          /** This filter is documented in wp-includes/post-template.php */
          $item_output .= '<span class="dropdown-toggle-link">'.$args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after.'</span>';
          $item_output .= '<span class="dropdown-toggle-btn"><i class="fas fa-caret-down"></i></span>';
          $item_output .= '</a>';
        } else {
        $item_output .= '<a'. $attributes .'>';
        /** This filter is documented in wp-includes/post-template.php */
